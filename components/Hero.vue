            ...
            <div class="row">
                <div class="col-lg-5 col-xl-6">
                    <div class="hero-content">
                        <h2 class="title text-gradient">Firmanıza sanal dünyada level atlatın.</h2>
                        <p><span class="hr d-none d-xl-block"></span> Modern tasarımlara sahip olun <br> Rakiplerinizin önüne geçin.</p>
