    ...
    <footer class="footer-section position-relative">
                    ...
                    <div class="col-12" data-aos="fade-up" data-aos-delay="600">
                        <div class="footer-card">
                            <div class="footer-row">
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        <n-link to="/" class="footer-logo">
                                            <img src="/images/logo/logo-white.svg" alt="Prime Web Ajans Logo" />
                                            <h1>Prime Web Ajans</h1>
                                        </n-link>
                                        <ul class="address">
                                            <li>
                                                <span class="icon">
                                                ...
                                                <a href="mailto:info@primewebajans.com">info@primewebajans.com</a>
                                            </li>
                                            <li>
                                               <span class="icon">
                                                    <i class="icofont-chat"></i>
                                                </span>
                                                <a href="javascript:void(0)" onclick="jivo_api.open()" class="btn btn-outline-warning fbtn">
                                                    Canlı Destek Alın <i class="icofont-arrow-right"></i>
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        ...
                                        <ul class="footer-menu">
                                            <li>
                                                <a class="footer-link" href="/ne-yapiyoruz#kurumsal-kimlik">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Kurumsal Kimlik
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/ne-yapiyoruz#web-site">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Web Site
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/ne-yapiyoruz#e-ticaret">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    E-Ticaret
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/ne-yapiyoruz#hosting-sunucu">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Hosting & Sunucu
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/ne-yapiyoruz#seo-calismasi">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Seo Çalışması
                                                </a>
                                            </li>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        <h4 class="title">Bilgiler</h4>
                                        <ul class="footer-menu">
                                            <li>
                                                <a class="footer-link" href="/biz-kimiz#prime-web-ajans">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Hakkımızda
                                                </a>
                                            </li>
                                            <li>
                                                <a class="footer-link" href="/biz-kimiz#neden-biz">
                                                    <i class="icofont-rounded-double-right"></i>
                                                    Neden Biz ?
                                                </a>
                                            </li>
                                ...
                                <div class="footer-col">
                                    <div class="footer-widget">
                                        ...
                                        <p>Sosyal medya üzerinde <span class="text-gradient">Prime Web Ajans</span>' ı takip edin.</p>
                                        <ul class="footer-social">
                                            <li class="footer-social-item">
                                                <a class="footer-social-link" href="https://instagram.com/primewebajans" target="_blank">
                                                    <i class="icofont-instagram mr-2"></i>
                                                    Takip Et
                                                </a>
                                            </li>
                                        </ul>
        ...
        <div class="copy-right-section">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <p><span class="text-gradient">Prime Web Ajans</span> &copy; {{currentDate.getFullYear()}} <span class="white">|</span> Tüm Hakları Saklıdır
                        </p>
                    </div>
                </div>
            </div>
