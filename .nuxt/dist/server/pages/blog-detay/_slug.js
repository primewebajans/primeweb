exports.ids = [39,4,20,24,25,27,28,29,30];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog-detay/_slug.vue?vue&type=template&id=3fb2636c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-container"},[_c('Header'),_vm._ssrNode(" "),_c('OffCanvasMobileMenu'),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"title":("" + _vm.blogTitle),"active-title":("" + _vm.blogTitle)}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"blog-details-section section-pt-150 section-pb-150\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-lg-12\"><div class=\"blog-details-thumb\"><img"+(_vm._ssrAttr("src",("" + _vm.image)))+" alt=\"images_not_found\" class=\"w-100 bdi\"></div></div> "),_vm._ssrNode("<div class=\"col-lg-4\">","</div>",[_vm._ssrNode("<aside class=\"sidebar\">","</aside>",[_c('AboutBanner'),_vm._ssrNode(" <div class=\"sidebar-widget tag-card\"><h3 class=\"title\">Etiketler</h3> <ul>"+(_vm._ssrList((_vm.tags),function(tag){return ("<li class=\"tag-item\"><a href=\"#\" class=\"tag-link\">"+_vm._ssrEscape(_vm._s(tag))+"</a></li>")}))+"</ul></div>")],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-8 ps-xl-7\">","</div>",[_c('v-card-text',{domProps:{"innerHTML":_vm._s(_vm.text)}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"next-prev-section next-prev-section2\">","</div>",[_vm._ssrNode("<div class=\"row mb-n4 align-items-center\">","</div>",[_vm._ssrNode("<div class=\"col-md-4 mb-4 col-6 order-1 order-md-0\">","</div>",[_vm._ssrNode("<div class=\"service-prev service-media\">","</div>",[_vm._ssrNode("<div class=\"content\">","</div>",[_vm._ssrNode("<h4 class=\"title\">"+_vm._ssrEscape(_vm._s(_vm.prevTitle))+"</h4> "),_c('n-link',{staticClass:"link",attrs:{"to":("/blog-detay/" + _vm.prevSlug)}},[_c('i',{staticClass:"icofont-rounded-double-left"}),_vm._v(" Önceki Yazı")])],2)])]),_vm._ssrNode(" <div class=\"col-md-4 mb-4\"></div> "),_vm._ssrNode("<div class=\"col-md-4 mb-4 col-6 order-2 order-md-0\">","</div>",[_vm._ssrNode("<div class=\"service-next service-media\">","</div>",[_vm._ssrNode("<div class=\"content\">","</div>",[_vm._ssrNode("<h4 class=\"title\">"+_vm._ssrEscape(_vm._s(_vm.nextTitle))+"</h4> "),_c('n-link',{staticClass:"link",attrs:{"to":("/blog-detay/" + _vm.nextSlug)}},[_vm._v("Sonraki Yazı "),_c('i',{staticClass:"icofont-rounded-double-right"})])],2)])])],2)])],2)],2)])]),_vm._ssrNode(" "),_c('Footer'),_vm._ssrNode(" "),_c('ScrollTop')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog-detay/_slug.vue?vue&type=template&id=3fb2636c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog-detay/_slug.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var _slugvue_type_script_lang_js_ = ({
  ...
  async fetch() {
    this.blogs = await fetch('http://primewebajans.com/data/blog.json').then(res => res.json());
    const single = blogs.find(el => el.slug === params.slug);
...
// CONCATENATED MODULE: ./pages/blog-detay/_slug.vue?vue&type=script&lang=js&
 /* harmony default export */ var blog_detay_slugvue_type_script_lang_js_ = (_slugvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/blog-detay/_slug.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  blog_detay_slugvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* nuxt-component-imports */
installComponents(component, {Header: __webpack_require__(23).default,OffCanvasMobileMenu: __webpack_require__(28).default,Breadcrumb: __webpack_require__(30).default,AboutBanner: __webpack_require__(31).default,Footer: __webpack_require__(24).default,ScrollTop: __webpack_require__(29).default})
