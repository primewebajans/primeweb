exports.ids = [43,20,24,25,27,28,29,30];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/ne-yapiyoruz.vue?vue&type=template&id=69a54903&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-container"},[_c('Header'),_vm._ssrNode(" "),_c('OffCanvasMobileMenu'),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"title":"Neler Sunuyoruz ?","active-title":"Ne Yapıyoruz"}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"service-details-section\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row mtn-35\"><div class=\"col-12 mt-35\"><div class=\"service-details\"><div class=\"service-details-list\"><h2 class=\"title mt-35\">Prime Web Ajans Olarak;</h2> <p>Siz değerli müşterilerimize 5 adet hizmet sunmaktayız. Hizmetlerimize göz atarak neler sunduğumuz hakkında daha iyi fikir sahibi olabilirsiniz.</p></div></div></div></div> "),(_vm.$fetchState.pending)?_vm._ssrNode("<p>","</p>",[_vm._ssrNode("Referans Listesi Yükleniyor...")],2):(_vm.$fetchState.error)?_vm._ssrNode(("<p>Bir Hata Oluştu :(</p>")):_vm._l((_vm.services),function(service){return _vm._ssrNode("<div"+(_vm._ssrAttr("id",("" + (service.slug))))+" class=\"service-details pt-h \">","</div>",[_vm._ssrNode("<div class=\"service-details-list\">","</div>",[_vm._ssrNode("<div class=\"row mtn-35\">","</div>",[_vm._ssrNode("<div"+(_vm._ssrClass(null,("col-lg-6 mt-30 " + (service.imagep))))+"><img"+(_vm._ssrAttr("src",("" + (service.image))))+(_vm._ssrAttr("alt",("" + (service.title))))+" class=\"experience\"></div> "),_vm._ssrNode("<div class=\"col-12 col-lg-6 mt-30\">","</div>",[_vm._ssrNode("<h2 class=\"title\">"+_vm._ssrEscape(_vm._s(service.title))+"</h2> "),_c('v-card-text',{domProps:{"innerHTML":_vm._s(service.text)}})],2)],2)])])})],2)]),_vm._ssrNode(" "),_c('Footer'),_vm._ssrNode(" "),_c('ScrollTop')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/ne-yapiyoruz.vue?vue&type=template&id=69a54903&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/ne-yapiyoruz.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var ne_yapiyoruzvue_type_script_lang_js_ = ({
  components: {
  ...
  async fetch() {
    this.services = await fetch('http://primewebajans.com/data/services.json').then(res => res.json());
  }

});
// CONCATENATED MODULE: ./pages/ne-yapiyoruz.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_ne_yapiyoruzvue_type_script_lang_js_ = (ne_yapiyoruzvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./pages/ne-yapiyoruz.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_ne_yapiyoruzvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var ne_yapiyoruz = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=ne-yapiyoruz.js.map