exports.ids = [37,4,20,24,25,27,28,29,30];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog.vue?vue&type=template&id=6f0f9184&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"main-container"},[_c('Header'),_vm._ssrNode(" "),_c('OffCanvasMobileMenu'),_vm._ssrNode(" "),_c('Breadcrumb',{attrs:{"title":"Blog","active-title":"Blog"}}),_vm._ssrNode(" "),_vm._ssrNode("<section class=\"section-pt-150 section-pb-150\">","</section>",[_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row mtn-35\">","</div>",[_vm._ssrNode("<div class=\"col-lg-8 mt-35\">","</div>",[_vm._ssrNode("<div class=\"row mtn-35\">","</div>",[(_vm.$fetchState.pending)?_vm._ssrNode("<p>","</p>",[_vm._ssrNode("Blog Listesi Yükleniyor...")],2):(_vm.$fetchState.error)?_vm._ssrNode(("<p>Bir Hata Oluştu :(</p>")):_vm._l((_vm.blogs),function(blog){return _vm._ssrNode("<div class=\"col-12 col-md-6 mt-35\">","</div>",[_vm._ssrNode("<div class=\"blog-grid-card\">","</div>",[_c('n-link',{staticClass:"blog-grid-thumb",attrs:{"to":("/blog-detay/" + (blog.slug))}},[_c('img',{attrs:{"src":blog.image,"alt":blog.title}})]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"blog-grid-content\">","</div>",[_vm._ssrNode("<ul><li class=\"date\"><i class=\"icofont-ui-calendar\"></i>"+_vm._ssrEscape("\n                                            "+_vm._s(blog.date)+"\n                                        ")+"</li></ul> "),_vm._ssrNode("<h5 class=\"title mb-3\">","</h5>",[_c('n-link',{attrs:{"to":("/blog-detay/" + (blog.slug))}},[_vm._v(_vm._s(blog.title))])],1),_vm._ssrNode(" <p class=\"mb-4\">"+_vm._ssrEscape("\n                                        "+_vm._s(blog.description)+"\n                                    ")+"</p> "),_c('n-link',{staticClass:"btn btn-warning",attrs:{"to":("/blog-detay/" + (blog.slug))}},[_vm._v("Devamını Oku")])],2)],2)])})],2)]),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-lg-4 mt-35\">","</div>",[_vm._ssrNode("<aside class=\"sidebar\">","</aside>",[_c('AboutBanner'),_vm._ssrNode(" <div class=\"sidebar-widget tag-card\"><h3 class=\"title\">Etiketler</h3> <ul>"+(_vm._ssrList((_vm.tags),function(tag){return ("<li class=\"tag-item\"><a href=\"#\" class=\"tag-link\">"+_vm._ssrEscape(_vm._s(tag))+"</a></li>")}))+"</ul></div>")],2)])],2)])]),_vm._ssrNode(" "),_c('Footer'),_vm._ssrNode(" "),_c('ScrollTop')],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/blog.vue?vue&type=template&id=6f0f9184&
